    ...
    <div className="flex flex-col rounded-sm border-2 border-black text-black my-5 w-64">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex gap-2 justify-center">
          ...
          <button onClick={handleAgregar} className="bg-amber rounded-sm px-2 py-1 hover:bg-gray-500 hover:text-amber-50 flex  items-center gap-1 hover:cursor-pointer">Añadir<ShoppingCartIcon className="size-4" /></button>
        </div>
      </div>
    </div>
  )
